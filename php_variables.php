...
<body>
 <?php
	...
	//in php a variable is always declard by starting with a '$' sign, see the examples below 
 	...
 	echo 'my favourite number is the number ' . $number . '<br>'; //a '.' is used to concatenate variables to a string.
 ...
 <a href="index.php">PHP Syntax</a>
 <a href="php_echo_print.php">PHP Echo/Print</a>
</body>
</html>